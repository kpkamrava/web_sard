...
namespace web_db
{
    public partial class sardweb_Context : DbContext
    {
        ...
        public virtual DbSet<TblTempRow> TblTempRows { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.;Database=web_sard;user=sa;password=2860120874@@@Kamal");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblContractType>(entity =>
            {
                ...
                entity.Property(e => e.OtbasculkalaCode)
                    .HasMaxLength(50)
                    .HasColumnName("OTbasculkalaCode");

                entity.Property(e => e.OtcodHesabFactor)
                    .HasMaxLength(50)
                    .HasColumnName("OTcodHesabFactor");

                entity.Property(e => e.OtcodHesabKargar)
                    .HasMaxLength(50)
                    .HasColumnName("OTcodHesabKargar");

                entity.Property(e => e.OtcodeMarkaz).HasColumnName("OTcodeMarkaz");

                entity.Property(e => e.OttypeFaktor).HasColumnName("OTtypeFaktor");

                entity.Property(e => e.OttypeFaktorInBack).HasColumnName("OTtypeFaktorInBack");

                entity.Property(e => e.OttypeFaktorOut).HasColumnName("OTtypeFaktorOut");

                entity.Property(e => e.OttypeFaktorOutBack).HasColumnName("OTtypeFaktorOutBack");
                ...
                entity.Property(e => e.PriceOfBoxInKargar)
                    .HasColumnType("decimal(22, 4)")
                    .HasColumnName("priceOfBoxInKargar")
                    .HasDefaultValueSql("((0))")
                    .HasAnnotation("Relational:ColumnType", "decimal(22, 4)");

                entity.Property(e => e.PriceOfBoxOutKargar)
                    .HasColumnType("decimal(22, 4)")
                    .HasColumnName("priceOfBoxOutKargar")
                    .HasDefaultValueSql("((0))")
                    .HasAnnotation("Relational:ColumnType", "decimal(22, 4)");

                entity.Property(e => e.PriceOfKiloInKargar)
                    .HasColumnType("decimal(22, 4)")
                    .HasColumnName("priceOfKiloInKargar")
                    .HasDefaultValueSql("((0))")
                    .HasAnnotation("Relational:ColumnType", "decimal(22, 4)");

                entity.Property(e => e.PriceOfKiloOutKargar)
                    .HasColumnType("decimal(22, 4)")
            ...
            modelBuilder.Entity<TblTemp>(entity =>
            {
                ...
                entity.Property(e => e.DateTaiid)
                    .HasColumnType("date")
                    .HasAnnotation("Relational:ColumnType", "date");

                entity.Property(e => e.FkuserAdd).HasColumnName("FKuserAdd");

                entity.Property(e => e.FkuserTaiid).HasColumnName("FKUserTaiid");

                entity.Property(e => e.Txt).HasMaxLength(250);

                entity.HasOne(d => d.FkuserAddNavigation)
                    .WithMany(p => p.TblTemps)
                    .HasForeignKey(d => d.FkuserAdd)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TblTemp_TblUser");
            });

            modelBuilder.Entity<TblTempRow>(entity =>
            {
                entity.ToTable("TblTempRow");

                entity.Property(e => e.Id).ValueGeneratedNever();

                entity.Property(e => e.A).HasMaxLength(50);

                entity.Property(e => e.ColorZani).HasMaxLength(50);
                ...
                entity.Property(e => e.FkUserEdit).HasColumnName("fkUserEdit");

                entity.Property(e => e.Fktemp).HasColumnName("FKTemp");

                entity.Property(e => e.M).HasMaxLength(50);

                entity.Property(e => e.Nezafat).HasMaxLength(50);

                entity.Property(e => e.O).HasMaxLength(50);

                entity.Property(e => e.SamPashi).HasMaxLength(50);

                entity.Property(e => e.Txt).HasMaxLength(150);

                entity.HasOne(d => d.FkLocation1Navigation)
                    .WithMany(p => p.TblTempRows)
                    .HasForeignKey(d => d.FkLocation1)
                    .HasConstraintName("FK_TblTempRow_TblLocation");

                entity.HasOne(d => d.FkUserAddNavigation)
                    .WithMany(p => p.TblTempRows)
                    .HasForeignKey(d => d.FkUserAdd)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TblTempRow_TblUser");

                entity.HasOne(d => d.FktempNavigation)
                    .WithMany(p => p.TblTempRows)
                    .HasForeignKey(d => d.Fktemp)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TblTempRow_TblTemp");
            });

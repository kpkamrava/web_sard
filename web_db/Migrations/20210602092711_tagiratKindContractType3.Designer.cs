...
namespace web_db.Migrations
{
    ...
    [Migration("20210602092711_tagiratKindContractType3")]
    partial class tagiratKindContractType3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("web_db.TblConf", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("web_db.TblContractType", b =>
                {
                    ...
                    b.Property<bool>("IsContractRequred")
                        .HasColumnType("bit");

                    b.Property<bool>("IsJabeJaii")
                        .HasColumnType("bit");

                    b.Property<bool>("IsMahvate")
                        .HasColumnType("bit");

                    b.Property<int>("KindCotractType")
                        .HasColumnType("int");

                    b.Property<bool>("OtSanadByGroup")
                        .HasColumnType("bit");

                    b.Property<int>("OtSanadPortageKind")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("web_db.TblPacking", b =>
                {
                    ...
                    b.Property<string>("ForContractTypeJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("web_db._note.TblNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("web_db._note.TblNoteDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FkTblNote")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("FromDate")
                        .HasColumnType("date");

                    b.Property<int>("KindBesorat")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FkTblNote");

                    b.ToTable("TblNoteDates");
                });

            modelBuilder.Entity("web_db._note.TblNoteRoll", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TblNoteRolls");
                });

            modelBuilder.Entity("web_db._note.TblNoteRows", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ForUserroll");

                    b.ToTable("TblNoteRows");
                });

            modelBuilder.Entity("web_db._queu.TblQueu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CodeMahsuls")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("ContractID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("KindQueu")
                        .HasColumnType("int");

                    b.Property<string>("Mahsuls")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("codesend")
                        .HasColumnType("int");

                    b.Property<DateTime>("date")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("datecodesend")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("web_db._temp.TblTemp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("web_db._temp.TblTempRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("web_db._note.TblNoteDate", b =>
                {
                    b.HasOne("web_db._note.TblNote", "TblNote")
                        .WithMany("TblNoteDates")
                        .HasForeignKey("FkTblNote")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TblNote");
                });

            modelBuilder.Entity("web_db._note.TblNoteRoll", b =>
                {
                    b.HasOne("web_db._note.TblNote", "TblNote")
                        .WithMany("TblNoteRolls")
                        .HasForeignKey("FkTblNote")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("web_db._queu.TblQueu", b =>
                {
                    b.HasOne("web_db.TblContract", "Contract")
                        .WithMany()
            ...
            modelBuilder.Entity("web_db._temp.TblTempRow", b =>
                {
                    b.HasOne("web_db._temp.TblTemp", "FktempNavigation")
            ...
            modelBuilder.Entity("web_db._note.TblNote", b =>
                {
                    b.Navigation("TblNoteDates");

                    b.Navigation("TblNoteRolls");

                    b.Navigation("TblNoteRows");
                });
